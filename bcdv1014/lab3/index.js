...
const contractAddress = '0x2002D3812F58e35F0EA1fFbf80A75a38c32175fA';
const contract = new ethers.Contract(contractAddress, abi, provider);

const wallet = new ethers.Wallet(process.env.PRIVATE_KEY, provider);
const contractWithSigner = contract.connect(wallet);

const filter = contract.filters.Transfer('0x4A299518adE496EaBc388cAEbD3E9E445aD07Ee8');

const waitOrFail = async () => {
    const transaction = await contractWithSigner.transfer('0x2002D3812F58e35F0EA1fFbf80A75a38c32175fA', 200);
        console.log(transaction);
        const stopIfFails = setTimeout(() => {
            provider.removeAllListeners(filter);
        }, 10000);

    clearTimeout(stopIfFails);

    const receipt = await provider.waitForTransaction(transaction.hash);
    console.log(receipt);
    //TODO: check for status too, write clean and robust code!
}
